...
urlpatterns = [
    ...
    path('admin/dashboard/events/<int:event_id>/schedule/', admin.event_schedule, name='event_schedule'),
    path('admin/dashboard/events/<int:event_id>/schedule/edit/', admin.edit_schedule, name='edit_item_event'),
    path('admin/dashboard/events/<int:event_id>/schedule/add/', admin.add_schedule_item, name='create_item_event'),
    path('admin/dashboard/events/schedule/<int:item_id>/delete/', admin.delete_schedule_item, name='delete_item_event'),
